...
3. Determine the expected output (positive testing)

4. Brainstorm the ways it could go wrong (negative testing)

5. Figure out where it touches other code
...
- Run in the console during development

- Focus on the positive, but don't forget negative and integration tests
...
- Run when the functional code changes, triggered manually or automatically
...
`shinytest::testApp("my_shiny_app")`
